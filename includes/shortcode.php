...
class ucf_people_directory_shortcode {
	const version               = "2.7.5"; // current shortcode version - manually update along with version in main php file whenever pushing a new version. used for cache busting, to prevent version incompatibilities.
